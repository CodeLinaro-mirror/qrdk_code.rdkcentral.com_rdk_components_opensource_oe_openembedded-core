...
do_install () {
        install -d ${D}${libdir}
        install -d ${D}${bindir}
        install -d ${D}${includedir}/openssl-1.1.1g
	...
	oe_multilib_header openssl/opensslconf.h
        ...
        sed -i '/^includedir=/ s%$%\/openssl-1.1.1g%' ${D}/${libdir}/pkgconfig/*.pc
        sed -i s%\-lcrypto%\-lcrypto-1.1.1g% ${D}/${libdir}/pkgconfig/*.pc
        sed -i s%\-lssl%\-lssl-1.1.1g% ${D}/${libdir}/pkgconfig/*.pc
        mv ${D}${includedir}/openssl ${D}${includedir}/openssl-1.1.1g
        mv ${D}${bindir}/openssl ${D}${bindir}/openssl-1.1.1g
        mv ${D}${libdir}/libssl.so ${D}${libdir}/libssl-1.1.1g.so
        mv ${D}${libdir}/libcrypto.so ${D}${libdir}/libcrypto-1.1.1g.so
        mv ${D}${libdir}/libssl.a ${D}${libdir}/libssl-1.1.1g.a
        mv ${D}${libdir}/libcrypto.a ${D}${libdir}/libcrypto-1.1.1g.a
        mv ${D}${libdir}/pkgconfig/libcrypto.pc ${D}${libdir}/pkgconfig/libcrypto-1.1.1g.pc
        mv ${D}${libdir}/pkgconfig/libssl.pc ${D}${libdir}/pkgconfig/libssl-1.1.1g.pc
        mv ${D}${libdir}/pkgconfig/openssl.pc ${D}${libdir}/pkgconfig/openssl-1.1.1g.pc
...
PACKAGES =+ "libcrypto-1.1.1g libssl-1.1.1g openssl-conf-1.1.1g ${PN}-engines ${PN}-misc"
